  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col font-sans overflow-x-hidden">
      ...
      <div className="relative z-20 w-full lg:max-w-7xl mx-auto px-0 md:px-4 -mt-24 md:-mt-32 pb-24">
        <div className="flex overflow-x-auto md:grid md:grid-cols-4 shadow-2xl snap-x snap-mandatory no-scrollbar">
          {cards.map((card, idx) => (
            <motion.div
              key={idx}
              ...
              className={`
                ...
                flex flex-col 
                border-r border-slate-900/5 last:border-0 
            ...
            >
              ...
              <p className={`text-sm md:text-[15px] leading-relaxed font-bold opacity-80 mb-8 md:mb-10 ${card.textColor}`}>
                {card.desc}
              </p>

              {/* ACTION SECTION */}
              <div className="mt-auto">
                <button className={`inline-flex items-center gap-2 px-6 py-2 border-2 rounded-full text-[10px] font-black uppercase tracking-widest transition-all duration-300 cursor-pointer ${card.btnStyle}`}>
